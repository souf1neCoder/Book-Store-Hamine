...
$books = $booksController->getBooksController();
...
<section id="books">
    <div class="books-main padding">
        <div class="container">
            <h3 class="text-center title-head">quelques livres</h3>
            <div class="row mt-5 justify-content-center books_dooom">
                        ...
                        <div class="book-me">
                            <div class="book">
                                ...
                                <div class="book-info">
                                    ...
                                    <a class="button text-center" href="<?php base_url ?>?page=livre&id-livre=<?php echo $book['unique_id'] ?>">DÉTAIL</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12 text-center my-3">
                        <a href="<?php base_url ?>?page=collection" class="v_plus ">Voir plus</a>
                </div>
            </div>
        </div>
    </div>
